...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_ortho_4x12(
    ...
    KC_TILD, _______, _______, _______, _______, _______,     KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, KC_BSLS,
  ...
  [_RAISE] = LAYOUT_ortho_4x12(
    ...
    KC_GRV,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______,     KC_LCBR, KC_LBRC, KC_RBRC, KC_RCBR, _______, KC_PIPE,
